package com.demo.base.persistence.mapper;

import com.demo.base.model.PageData;
import lombok.val;
...
public interface PageMapper {
    ...
    default <E> PageData<E> MapToPageData(final PageData<?> page, final List<E> elements) {
        return PageData.<E>builder()
                .content(elements)
                .totalElements(page.getTotalElements())
